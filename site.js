...
if (pagePath === '/' || pagePath === '/index.html') {
  ...
  style.textContent = `
    ...
    .phan-join-copy { max-width: 1100px; }
    .phan-join .phan-eyebrow { margin-bottom: 10px; color: #b7c8bd; }
    .phan-join h2 { max-width: 1100px; font-size: clamp(36px, 4vw, 54px); color: #fff; white-space: nowrap; }
    .phan-join p { max-width: 1000px; margin: 18px 0 0; color: rgba(255,255,255,.82); font-size: 15px; line-height: 1.8; }
    ...
    @media (max-width: 760px) {
      ...
      .phan-join-copy { max-width: 100%; }
      .phan-join h2 { font-size: clamp(34px, 9vw, 46px); white-space: normal; }
      .phan-join p { max-width: 100%; font-size: 14px; }
